...
var categoryStrategyLevels = function() {
	var level1 = [
			...
			},
			{
				...
				useCase: {name: "ProcureToPay11B", link: {x: -20, y: 70}},
			} ]
	return [ {
		p2pObject : level1,
...
var contractAdministrationP2PLevels = function() {
	var level1 = [
			...
			},
			{
				...
				useCase: {name: "ProcureToPay31B", link: {x: -150, y: -50}},
			} ]
...
var pOsAndRecievingLevels = function() {
	var level1 = [ {
		...
		wrapLength : 110,
		levels : [],
		useCase: {name: "ProcureToPay511U", link: {x: -115, y: 120}},
...
var orderManagementLevels = function() {
	var level1 = [ {
		...
		//useCase: [{name: "QuoteToCash42U", link: {x: 10, y: -20}}],
...
var billingLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "QuoteToCash51U", link: {x: -30, y: +25}},
...
var cashApplicationLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "QuoteToCash51U2", link: {x: 30, y: -15}}
	} ]
...
var collectionsAndDisputeManagementLevels = function() {
	var level1 = [ {
		...
		angle : -280,
		levels : [],
		useCase: {name: "QuoteToCash72U", link: {x: +70, y: -10}}
		//deploymentsCase: {name: "QuoteToCash72", link: {x: 70, y: -25}}
	}, {
...
var reportingLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "RecordToReport21U", link: {x: -60, y: -60}}
	} ]
...
var internetCompanyLevels = function() {
	var level1 = [ {
		...
		angle : -90,
		levels : [],
		deploymentsCase: {name: "RecordToReport41", link: {x: -120, y: -10}},
	}, {
...
var engagementCommunicationsLevels = function() {
	...
	var level2 = [ {
		...
		deploymentsCase: {name: "HireToRetire71", link: {x: -35, y: +55}},
	} ]
...
var incidentManagementContinuousImprovementLevels = function() {
	var level1 = [ {
		...
		angle : -80,
		levels : [],
		deploymentsCase: {name: "ItTransitionToOperationCI21U", link: {x: -10, y: -60}},
		end : "end"
	} ]
...
var demandSensingLevels = function() {
	var level1 = [ {
		...
		levels : [],
		useCase: {name: "PlanToDelivery12", link: {x: -50, y: +50}},
	}, {
		...
		deploymentsCase: {name: "PlanToDelivery14B", link: {x: 20, y: 50}},
	} ]
...
var supplyNetworkPlanningLevels = function() {
	...
	var level2 = [ {
		...
		useCase: {name: "PlanToDelivery21B", link: {x: 20, y: -70}}
	} ]
...
var inboundLogisticsWarehousingLevels = function() {
	var level1 = [ {
		...
		angle : -0,
		levels : [],
		deploymentsCase: {name: "PlanToDelivery63", link: {x: 25, y: -50}},
